...
session_start();
  ...
  $house="select * from house where Id = $id";
...
<body>
    <header class="fixed top-0 right-0 left-0 text-black body-font bg-orange-300">
          ...
          <div class="lg:w-4/5 mx-auto flex flex-wrap">
            <div class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
              ...
              <div class="flex border-t border-black py-2">
                ...
                <span class="ml-auto text-black"><?php echo $res['size']; ?></span>
              </div>
              <div class="flex border-t border-b mb-6 border-black py-2">
                <span class="text-black">Cost/Rent</span>
                <span class="ml-auto text-black"><?php echo $res['cost']; ?></span>
              </div>
              <div class="flex">
                <button class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Rent</button>
              </div>
            </div>
